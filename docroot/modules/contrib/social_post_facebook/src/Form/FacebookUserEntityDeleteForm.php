...
/**
 * Provides a form for deleting Facebook user entities.
 *
 * @ingroup social_post_facebook
 */
class FacebookUserEntityDeleteForm extends ContentEntityDeleteForm {
  ...
  /**
   * FacebookUserEntityDeleteForm constructor.
   *
  ...
  protected function getRedirectUrl() {
    ...
    return Url::fromRoute('entity.social_post_facebook_user.collection');
  }
